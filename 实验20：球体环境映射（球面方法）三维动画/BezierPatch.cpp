...
void CBezierPatch::DrawFacet(CDC* pDC, CZBuffer* pZBuffer)
{
	...
	pZBuffer->SetPoint(ScreenPoint[0], ScreenPoint[2], ScreenPoint[3], CVector3(quadrP[0]), CVector3(quadrP[2]), CVector3(quadrP[3]));
	pZBuffer->PhongShader(pDC, ViewPoint, pLight, pMaterial, pTexture);
	pZBuffer->SetPoint(ScreenPoint[0], ScreenPoint[1], ScreenPoint[2], CVector3(quadrP[0]), CVector3(quadrP[1]), CVector3(quadrP[2]));
	pZBuffer->PhongShader(pDC, ViewPoint, pLight, pMaterial, pTexture);
}
